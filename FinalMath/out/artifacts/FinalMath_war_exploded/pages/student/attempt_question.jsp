...
<head>
    ...
    <script>
        window.onload = function () {
            responsiveVoice.speak("Listen to the question carefully. Say one, two or three for guidance. Say repeat please to listen to the question again. Let's simplify the equation. Are you ready?");
