...
<head>
    ...
    <script>
        ...
        window.onload = function () {
            loadAnnyang();
            loadJwerty();
            responsiveVoice.speak("You are on the Register page. If you already have an account, say Let me in to go to login page.!");
        };
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <p class="text-danger" id="error" value="${message}">${message}</p>
                    </div>
                </div>
            </div>
        </div>
