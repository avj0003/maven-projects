...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Practice Math Questions</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover"
                            ...
                            <c:forEach var="question" items="${questions}" varStatus="i">
                                <tr class="odd gradeX">
                                    ...
                                    <td><a id="${i.index + 1}" href="../../AttemptQuestion?id=${question.getQuestionId()}"
                                            class="btn btn-primary" style="float: right;">Attempt</a>${question.getTopicName()}</td>
                                </tr>
                            </c:forEach>
                         </tbody>
                     </table>
