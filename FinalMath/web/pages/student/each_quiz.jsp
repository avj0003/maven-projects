...
<script>
    window.onload = function () {
        loadAnnyang();
        loadJwerty();
        setTimeout(responsiveVoice.speak("You are on the Quiz Questions Page. Questions will be asked one at a time. Are you ready?"), 2000);
    };
    ...
    function loadAnnyang() {
        if (annyang) {
            var commands = {
                'Yes': function () {
                    setTimeout(responsiveVoice.speak("Excellent. Press any key from 1 to 9 to attempt question."), 2000);
                },
                'Practice': function() {
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Quiz Questions</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover"
                            ...
                            <c:forEach var="question" items="${questions}">
                                <tr class="odd gradeX">
                                    ...
                                    <td></td>
                                    <td><a id="<%= i %>" href="../../AttemptEachQuestion?id=${question.getQuestionId()}"
